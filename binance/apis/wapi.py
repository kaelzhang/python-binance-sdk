...
def define_getter(
    ...
    """Internal factory: build a concrete async WAPI/SAPI closure and install it on ``Target``."""
...
class WapiAPIGetters:
    """Internal mixin providing dynamically-generated async methods for Binance ``/wapi/`` and ``/sapi/`` endpoints."""
