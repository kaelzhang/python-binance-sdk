"""COIN-M Futures general WS-API endpoint stubs.
...
CM has no public ``ping`` / ``serverTime`` / ``exchangeInfo`` WS-API methods
...
class CMGeneralGetters:
    """Session-management mixin for :class:`CMFuturesGetters`."""
